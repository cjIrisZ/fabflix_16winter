...
public void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    private synchronized void login(String email, String password, HttpServletRequest request, HttpServletResponse response, Connection dbcon) throws SQLException, IOException, ServletException
    {        
        PrintWriter out = response.getWriter();
