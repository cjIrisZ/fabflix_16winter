		...
		PrintWriter out = response.getWriter();
			...
			total_result = id_list.size();
		        ...
		        t += "<form method=\"get\" action= \"movieDetail\">"
		            	  	...
		            	  	+ "<button onmouseover=\"mOver(this)\" onmouseout=\"mOut(this)\" type=\"submit\" class=\"btn btn-link\" role=\"link\" name=\"movie_title\">" 
		            	  	+ rs.getString("title") + "</button></form>";
		        
			String item = "",movie_info = "";
			movie_info = "<table class=\"table table-hover\">" 
